...
*)
totFactor = ((16*x65x0*x62x0*x38x0*x28x0*EE^2)/(1));
numerator =(2*SC[p1,p3]^2*x65x2*x62x2+2*SC[p1,p3]^2*x65x1*x62x1-2*SC[p1,p3]*
 ...
 x62x2*MD2^2-2*SC[p1,p3]*x65x1*x62x1*MD2^2+SC[p1,p2]^2*x65x2*x62x2+
 SC[p1,p2]^2*x65x1*x62x1+3*SC[p1,p2]*x65x2*x62x2*MD2^2+3*SC[p1,p2]*x65x1*
 x62x1*MD2^2+2*x65x2*x62x2*MD2^4+2*x65x1*x62x1*MD2^4);
...
*)
totFactor = ((8*x65x0^2*x38x0^2*EE^2)/(1));
numerator =(2*SC[p1,p3]^2*x65x2^2+2*SC[p1,p3]^2*x65x1^2-2*SC[p1,p3]*
 SC[p1,p2]*x65x2^2-2*SC[p1,p3]*SC[p1,p2]*x65x1^2-2*SC[p1,p3]*x65x2^2*MD2^2-
 2*SC[p1,p3]*x65x1^2*MD2^2+SC[p1,p2]^2*x65x2^2+SC[p1,p2]^2*x65x1^2+3*
 SC[p1,p2]*x65x2^2*MD2^2+3*SC[p1,p2]*x65x1^2*MD2^2+2*x65x2^2*MD2^4+2*x65x1^
 2*MD2^4);
