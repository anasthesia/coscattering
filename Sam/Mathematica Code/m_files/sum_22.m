...
addToSum:=Module[
   {sqm},
   (*Laura changed /. substitutions into //. substitutions*)
   (*sqm=totFactor*numerator/denominator /.  propDen[p_,m_,w_]->(m^2-SC[p,p])*)
   sqm=totFactor*numerator/denominator /.  {propDen[p_,m_,w_]->((m^2-SC[p,p])^2+(m*w)^2)/(m^2-SC[p,p]),propDenSq[p_,m_,w_]->((m^2-SC[p,p])^2+(m*w)^2) };
