(*
     ...
     *  CalcHEP  3.7 *
     ==============================
  process  ~Chi2(p1)+~Chi2~(p2)->d(p3)+d~(p4)
*)
...
*)
totFactor = ((24*x53x0^2*x28x0^2*EE^2)/(1));
numerator =(2*SC[p1,p3]^2*x53x2^2+2*SC[p1,p3]^2*x53x1^2-2*SC[p1,p3]*
 SC[p1,p2]*x53x2^2-2*SC[p1,p3]*SC[p1,p2]*x53x1^2-2*SC[p1,p3]*x53x2^2*MD2^2-
 2*SC[p1,p3]*x53x1^2*MD2^2+SC[p1,p2]^2*x53x2^2+SC[p1,p2]^2*x53x1^2+3*
 SC[p1,p2]*x53x2^2*MD2^2+3*SC[p1,p2]*x53x1^2*MD2^2+2*x53x2^2*MD2^4+2*x53x1^
 2*MD2^4);
...
*)
totFactor = ((48*x56x0*x53x0*x38x0*x28x0*EE^2)/(1));
numerator =(2*SC[p1,p3]^2*x56x2*x53x2+2*SC[p1,p3]^2*x56x1*x53x1-2*SC[p1,p3]*
 SC[p1,p2]*x56x2*x53x2-2*SC[p1,p3]*SC[p1,p2]*x56x1*x53x1-2*SC[p1,p3]*x56x2*
 x53x2*MD2^2-2*SC[p1,p3]*x56x1*x53x1*MD2^2+SC[p1,p2]^2*x56x2*x53x2+
 SC[p1,p2]^2*x56x1*x53x1+3*SC[p1,p2]*x56x2*x53x2*MD2^2+3*SC[p1,p2]*x56x1*
 x53x1*MD2^2+2*x56x2*x53x2*MD2^4+2*x56x1*x53x1*MD2^4);
...
*)
totFactor = ((24*x56x0^2*x38x0^2*EE^2)/(1));
numerator =(2*SC[p1,p3]^2*x56x2^2+2*SC[p1,p3]^2*x56x1^2-2*SC[p1,p3]*
 SC[p1,p2]*x56x2^2-2*SC[p1,p3]*SC[p1,p2]*x56x1^2-2*SC[p1,p3]*x56x2^2*MD2^2-
 2*SC[p1,p3]*x56x1^2*MD2^2+SC[p1,p2]^2*x56x2^2+SC[p1,p2]^2*x56x1^2+3*
 SC[p1,p2]*x56x2^2*MD2^2+3*SC[p1,p2]*x56x1^2*MD2^2+2*x56x2^2*MD2^4+2*x56x1^
 2*MD2^4);
