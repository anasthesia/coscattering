(*
     ...
     *  CalcHEP  3.7 *
     ==============================
  process  ~Chi1(p1)+u(p2)->u(p3)+~Chi1(p4)
*)
...
*)
totFactor = ((8*x71x0^2*x25x0^2*EE^2)/(1));
numerator =(SC[p1,p3]^2*x71x2^2+SC[p1,p3]^2*x71x1^2+SC[p1,p3]*x71x2^2*MD1^2+
 SC[p1,p3]*x71x1^2*MD1^2+SC[p1,p2]^2*x71x2^2+SC[p1,p2]^2*x71x1^2-SC[p1,p2]*
 x71x2^2*MD1^2-SC[p1,p2]*x71x1^2*MD1^2);
...
*)
totFactor = ((16*x74x0*x71x0*x35x0*x25x0*EE^2)/(1));
numerator =(SC[p1,p3]^2*x74x2*x71x2+SC[p1,p3]^2*x74x1*x71x1+SC[p1,p3]*x74x2*
 x71x2*MD1^2+SC[p1,p3]*x74x1*x71x1*MD1^2+SC[p1,p2]^2*x74x2*x71x2+SC[p1,p2]^
 2*x74x1*x71x1-SC[p1,p2]*x74x2*x71x2*MD1^2-SC[p1,p2]*x74x1*x71x1*MD1^2);
...
*)
totFactor = ((8*x74x0^2*x35x0^2*EE^2)/(1));
numerator =(SC[p1,p3]^2*x74x2^2+SC[p1,p3]^2*x74x1^2+SC[p1,p3]*x74x2^2*MD1^2+
 SC[p1,p3]*x74x1^2*MD1^2+SC[p1,p2]^2*x74x2^2+SC[p1,p2]^2*x74x1^2-SC[p1,p2]*
 x74x2^2*MD1^2-SC[p1,p2]*x74x1^2*MD1^2);
