(*
     ...
     *  CalcHEP  3.8.4 *
     ==============================
  process  ~Chi1(p1)+Chi1~(p2)->e-(p3)+e+(p4)
*)
...
p2/: SC[p2,p2] =MD1^2;
p3/: SC[p3,p3] =0^2;
p2/: SC[p2,p3] = -1*(0^2-MD1^2-MD1^2-0^2-2*SC[p1,p2]+2*SC[p1,p3])/2;
...
numerator =(2*SC[p1,p3]^2*x62x2^2+2*SC[p1,p3]^2*x62x1^2-2*SC[p1,p3]*
 SC[p1,p2]*x62x2^2-2*SC[p1,p3]*SC[p1,p2]*x62x1^2-2*SC[p1,p3]*x62x2^2*MD1^2-
 2*SC[p1,p3]*x62x1^2*MD1^2+SC[p1,p2]^2*x62x2^2+SC[p1,p2]^2*x62x1^2+3*
 SC[p1,p2]*x62x2^2*MD1^2+3*SC[p1,p2]*x62x1^2*MD1^2+2*x62x2^2*MD1^4+2*x62x1^
 2*MD1^4);
...
numerator =(2*SC[p1,p3]^2*x65x2*x62x2+2*SC[p1,p3]^2*x65x1*x62x1-2*SC[p1,p3]*
 SC[p1,p2]*x65x2*x62x2-2*SC[p1,p3]*SC[p1,p2]*x65x1*x62x1-2*SC[p1,p3]*x65x2*
 x62x2*MD1^2-2*SC[p1,p3]*x65x1*x62x1*MD1^2+SC[p1,p2]^2*x65x2*x62x2+
 SC[p1,p2]^2*x65x1*x62x1+3*SC[p1,p2]*x65x2*x62x2*MD1^2+3*SC[p1,p2]*x65x1*
 x62x1*MD1^2+2*x65x2*x62x2*MD1^4+2*x65x1*x62x1*MD1^4);
...
numerator =(2*SC[p1,p3]^2*x65x2^2+2*SC[p1,p3]^2*x65x1^2-2*SC[p1,p3]*
 SC[p1,p2]*x65x2^2-2*SC[p1,p3]*SC[p1,p2]*x65x1^2-2*SC[p1,p3]*x65x2^2*MD1^2-
 2*SC[p1,p3]*x65x1^2*MD1^2+SC[p1,p2]^2*x65x2^2+SC[p1,p2]^2*x65x1^2+3*
 SC[p1,p2]*x65x2^2*MD1^2+3*SC[p1,p2]*x65x1^2*MD1^2+2*x65x2^2*MD1^4+2*x65x1^
 2*MD1^4);
